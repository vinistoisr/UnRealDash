...
DS_EXPORT const char *CodeName(ErrorCode code);
DS_EXPORT Error Fail(ErrorCode code, std::string_view pointer, std::string_view message);
[[noreturn]] DS_EXPORT void ReportAssertion(const char *expression, const char *file, int line);
} // namespace dashboard_spec
